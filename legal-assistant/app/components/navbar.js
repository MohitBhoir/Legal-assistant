      ...
      <div className="container mx-auto flex items-center justify-between px-4 py-4">
        ...
        >
          {user ? (
            <div
              className={`flex ${
                isOpen && "grid grid-cols-1 md:grid-cols-2"
              } gap-4 items-center justify-center text-center w-full px-2 py-2`}
            >
              <Link
                href="/"
                className="block px-4 py-2 text-xl text-white md:inline
             hover:text-cyan-200 hover:text-3xl transition-all easy-in-out delay-100"
              ...
              <Link
                href="/about"
                className="block px-4 py-2 text-white md:inline text-xl hover:text-cyan-200 hover:text-3xl transition-all easy-in-out delay-100"
              >
                About
              </Link>
              <Link
                href="/templates"
                className="block px-4 py-2 text-xl text-white md:inline hover:text-cyan-200 hover:text-3xl transition-all easy-in-out delay-100"
              >
                Templates
              </Link>
              <Link
        ...
        <div className="md:hidden flex items-center">
          {user ? (
            ...
            <button
              ...
              className="px-6 py-2 bg-blue-800 text-white rounded-full hover:text-blue-800 hover:bg-white"
            >
              Get Started
            </button>
          )}
